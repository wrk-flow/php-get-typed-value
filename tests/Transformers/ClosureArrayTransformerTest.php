...
class ClosureArrayTransformerTest extends AbstractTransformerTestCase
{
    ...
    {
        $transformer = new ClosureArrayTransformer(function (mixed $value, string $key): ?string {
    ...
    protected function dataAfterValidationForTransformer(ClosureArrayTransformer $transformer): array
    {
        return [
            [
                new TransformerExpectationEntity(
